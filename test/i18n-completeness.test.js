...
const PUBLISHER_BRACKET_OK = new Set([
  // "(CT Humanities)" names the parent organization behind ConnecticutHistory.org
  // — bibliography, not characterisation.
  'cthistory-charter',
  // "(Knights of Columbus)" / "(KofC)" after Columbia Magazine and the Father
  // McGivney Guild names the parent publisher — the perspective prose lives in
  // publisherNote.
  'columbia-under-god',
  'columbia-knights-vs-klan-2017',
  'mcgivney-guild-venerable',
  'mcgivney-guild-life',
  // "(EWTN)" names the Register's parent network.
  'ncregister-peter-claver',
  // "(New Catholic Encyclopedia)" and "(CT Humanities)"-style parent naming:
  // Encyclopedia.com republishes the named encyclopedia.
  'encyclopedia-daughters-isabella',
  'encyclopedia-callahan',
  // "(Indiana State Library)" names the program's host institution.
  'fiery-cross-hoosier',
  // "(Penn State journals)" names the hosting press of the journal.
  'jenkins-wph-kkk-pa',
